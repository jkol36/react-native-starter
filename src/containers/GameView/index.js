    ...
    const { games } = this.props
        ...
        <FlatList 
          ...
          renderItem={({item}) => (
            ...
            >
            {this.state.selected.get(item.id) === true ? <SubCard 
              spreadValHome={'O'} 
              spreadValAway={'O'} 
              spreadValSecondaryAway={40} 
              spreadValSecondaryHome={40} 
              moneyValHome={40}
              moneyValAway={40}
              homeTeamSub={'Philadelphia Eagles'}
              awayTeamSub={'New York Giants'}
              totalValHome={40}
              totalValAway={40}
              />:null}
            </GameCard>
